    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-8 offset-2 bg-white">
                ...
                <div class="font-weight-bold text-center border-bottom pb-3 pt-3" style="font-size: 24px">写真アップロード</div>

                <form method="POST" action="{{ route('photo_upload') }}" class="p-5" enctype="multipart/form-data">
                    @csrf
